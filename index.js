...
printIngredients = (value, index) => {
  ...
  render() {   
    ...
    <div id="container">
      <div id="header1">
         <div></div>
         <div><h1 id="main">{this.state.Reciepe.strMeal}</h1></div>
      ...
      <div id="description">
        ...
        <div id="right">
         <i>Category of the Meal - </i>{this.state.Reciepe.strCategory}
         <br/>
         <i>Area of the Meal - </i>{this.state.Reciepe.strArea}
         <br/>
         <br/>
         ...
         <div id="recipe">
         {this.state.Reciepe.strInstructions}
         </div>
        </div>
      </div>
    </div>
